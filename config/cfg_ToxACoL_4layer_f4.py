config = {
    ...
    'seed':[20240625,20240624,20240201,20230630,1230630,20300630,2024622,12349,54670981,2028101],
    'train_fold_file': 'train_fold_4.txt',
    'test_fold_file': 'test_fold_4.txt',
